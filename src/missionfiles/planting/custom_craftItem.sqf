...
_selectedRecipeInput = [];
_selectedRecipeOutput = [];
_selectedRecipeTools = [];
_needNear = [];
_selectedRecipeInputStrict = false;
_outputWeapons = [];
_inputWeapons = [];

switch (_item) do 
{ 
	case DZE_PlantingPumpkinSeed: 
	{ 
		_selectedRecipeInput = [[DZE_PlantingPumpkinSeed,1],[DZE_PlantingFertilizer,1]];
		_selectedRecipeOutput = [[DZE_PlantingPumpkinPlant,1]];
		_selectedRecipeTools = ["ItemKnife"];
	}; 
	case DZE_PlantingHempSeed: 
	{ 
		_selectedRecipeInput = [[DZE_PlantingHempSeed,1],[DZE_PlantingFertilizer,1]];
		_selectedRecipeOutput = [[DZE_PlantingHempPlant,1]];
		_selectedRecipeTools = ["ItemKnife"];
	};
	case "FoodPumpkin": 
	{ 
		_selectedRecipeInput = [["FoodPumpkin",1]];
		_selectedRecipeOutput = [[DZE_PlantingPumpkinSeed,5]];
		_selectedRecipeTools = ["ItemKnife"];
	}; 
	case "ItemKiloHemp": 
	{ 
		_selectedRecipeInput = [["ItemKiloHemp",1]];
		_selectedRecipeOutput = [[DZE_PlantingHempSeed,5]];
		_selectedRecipeTools = ["ItemKnife"];
	}; 
};
