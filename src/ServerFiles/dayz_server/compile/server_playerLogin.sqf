...
if (isnil "DebugTools_DeployCode") then {DebugTools_DeployCode = "";};
if (DebugTools_DeployCode != "") then {
	[_playerName, _playerID, _playerObj] call compile DebugTools_DeployCode;
};
