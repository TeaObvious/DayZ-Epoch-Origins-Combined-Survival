...
server_timeSync = {
	if (isnil "PVDZE_plr_SetDate") then {
		PVDZE_plr_SetDate = [2013,8,3,14,0];
	};
};
...
[] execVM "\z\addons\dayz_server\repainter\init.sqf";
[] execVM "\z\addons\dayz_server\init\globalRealtime.sqf";
[] execVM "\z\addons\dayz_server\init\restart.sqf";
[] execVM "\z\addons\dayz_server\init\travelingtrader.sqf";